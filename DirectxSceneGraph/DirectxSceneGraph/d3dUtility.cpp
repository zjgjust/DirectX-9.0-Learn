	...
	IDirect3DDevice9** device)
{
	...
	HWND hwnd = 0;
	hwnd = ::CreateWindow("MySnowManApp", "MySnowManApp", 
		WS_EX_TOPMOST,
		0, 0, width, height,
...
{
	// infinite small 
	_min.x = d3d::MYINFINITY;
	_min.y = d3d::MYINFINITY;
	_min.z = d3d::MYINFINITY;

	_max.x = -d3d::MYINFINITY;
	_max.y = -d3d::MYINFINITY;
	_max.z = -d3d::MYINFINITY;
}
